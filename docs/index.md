...
# UNO AI agent Algorithm

This website explains
- the Project and Game we targeted
- The algorithm design
- Our results and next step
...
- Operating System: Windows, macOS, or Linux with Python 3.7+
...
The Game was fun to build and tested our understanding of the concepts we learned